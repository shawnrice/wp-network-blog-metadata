...
class Network_Blog_Metadata_Table extends WP_List_Table {
    ...
    function column_default( $item, $column_name ) {
        ...
        case 'purpose':
            ...
            case 'registered': return $item[$column_name];
        default:
    ...
    function prepare_items() {
        ...
        $sql = '
            SELECT ' . $tablename . '.blog_id , ' . $tablename . '.role , ' .
            $tablename . '.purpose , ' . $blogs . '.path , ' . $blogs . '.domain , ' .
            $blogs . '.registered FROM ' . $tablename . '
            INNER JOIN ' . $blogs . '
        ...
        $blog_data = (array)$wpdb->get_results( "
            SELECT `blog_id` , `domain` , `path` , `registered` FROM " . $blogs
        );
