	...
	$(document).ready(function() {
		$('input[name="signup_with_blog"]').change(function(){
				if ( $(this).prop('checked') == true ) {
					$('#nbm_table_form').fadeIn(200);
				} else if ( $(this).prop('checked') == false ) {
					$('#nbm_table_form').fadeOut(200);
				}		
		});
